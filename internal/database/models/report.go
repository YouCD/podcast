...
type Report struct {
	...
	Genre          int        `gorm:"type:smallint;not null;default:1;comment:报告类型 1:日报 2:周报 3:月报" json:"genre"`
	PodcastMP3URL  string     `gorm:"type:varchar(255);not null;default:'';comment:播客地址" json:"podcast_mp3_url"`
	PodcastContent string     `gorm:"type:text;comment:播客内容" json:"podcast_content"`
